...
func (c *Client) SubmitBlockAsync(block *viautil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *viautil.Block, options *btcjson.SubmitBlockOptions) error {
