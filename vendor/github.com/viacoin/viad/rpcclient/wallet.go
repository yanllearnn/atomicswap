...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []viautil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []viautil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee viautil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee viautil.Amount) error {
...
func (c *Client) SendToAddressAsync(address viautil.Address, amount viautil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address viautil.Address, amount viautil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address viautil.Address,
	amount viautil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address viautil.Address, amount viautil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress viautil.Address, amount viautil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress viautil.Address, amount viautil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress viautil.Address, amount viautil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress viautil.Address, amount viautil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress viautil.Address, amount viautil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress viautil.Address,
	amount viautil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[viautil.Address]viautil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[viautil.Address]viautil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[viautil.Address]viautil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[viautil.Address]viautil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (viautil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return viautil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []viautil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []viautil.Address, account string) (viautil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []viautil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []viautil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (viautil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (viautil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (viautil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (viautil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (viautil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (viautil.Address, error) {
...
func (c *Client) GetAccountAsync(address viautil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address viautil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address viautil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address viautil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]viautil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]viautil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := viautil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]viautil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount viautil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount viautil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount viautil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount viautil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount viautil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount viautil.Amount,
...
func (c *Client) ValidateAddressAsync(address viautil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address viautil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]viautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]viautil.Amount)
	for k, v := range accounts {
		amount, err := viautil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]viautil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]viautil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (viautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := viautil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (viautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (viautil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (viautil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (viautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (viautil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (viautil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (viautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (viautil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (viautil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address viautil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address viautil.Address) (viautil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address viautil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address viautil.Address, minConfirms int) (viautil.Amount, error) {
...
func (c *Client) SignMessageAsync(address viautil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address viautil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address viautil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address viautil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*viautil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return viautil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address viautil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address viautil.Address) (*viautil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *viautil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *viautil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *viautil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *viautil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *viautil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *viautil.WIF, label string, rescan bool) error {
