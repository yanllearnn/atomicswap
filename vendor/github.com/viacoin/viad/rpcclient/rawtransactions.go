...
func (r FutureGetRawTransactionResult) Receive() (*viautil.Tx, error) {
	...
	return viautil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*viautil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	amounts map[viautil.Address]viautil.Amount, lockTime *int64) FutureCreateRawTransactionResult {
...
func (c *Client) CreateRawTransaction(inputs []btcjson.TransactionInput,
	amounts map[viautil.Address]viautil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsAsync(address viautil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address viautil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address viautil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address viautil.Address, skip,
