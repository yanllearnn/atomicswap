...
A Block defines a viacoin block that provides easier and more efficient
...
A Tx defines a viacoin transaction that provides more efficient manipulation of
...
To decode/encode an address:
	...
	addr, err := viautil.DecodeAddress(addrString, defaultNet)
	if err != nil {
		fmt.Println(err)
		return
	}
