...
// Block defines a viacoin block that provides easier and more efficient
...
// Tx returns a wrapped transaction (viautil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (viautil.Tx) for all
...
// instead provides easy access to wrapped versions (viautil.Tx) of them.
...
// NewBlock returns a new instance of a viacoin block given an underlying
...
// NewBlockFromBytes returns a new instance of a viacoin block given the
...
// NewBlockFromReader returns a new instance of a viacoin block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a viacoin block given
